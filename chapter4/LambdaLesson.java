...
public class LambdaLesson {
    ...
    public static void main(String[] args) {
        ...
        NumberInterface ni1 = (a,b,t)-> a*b+100;
        NumberInterface ni2 = (x,y,t)->{ return x+y;};
        System.out.println(ni1.aPlusB(4, 5, false));
        System.out.println(ni2.aPlusB(8, 9, true));
        DiscountItems tenPercent = (y)-> y-(y*0.10);
        DiscountItems twentyPercent = (y)-> y-(y*0.20);
        DiscountItems fiftyPercent = (y)-> y-(y*0.50);
        int itemPrice = 1000;
        System.out.println(tenPercent.dc(itemPrice));
        System.out.println(twentyPercent.dc(itemPrice));
        System.out.println(fiftyPercent.dc(itemPrice));
    }
