...
public class DatesAndTimeLesson {
    ...
    public static void main(String[] args) {
        ...
        LocalDate rexDate = LocalDate.of(1990, 1, 25); 
        Period dob = Period.between(rexDate, LocalDate.now());
        System.out.println(dob.getYears());
        System.out.println(rexDate.toEpochDay());
